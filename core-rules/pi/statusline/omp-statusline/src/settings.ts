...
import { INFORMATION_PROFILES } from "./information-profiles.ts";
...
export const DEFAULT_STATUSLINE_CONFIG: StatuslineConfig = {
	...
	segmentText: {
		...
		time: { prefix: "🕒 ", suffix: "" },
		turn: { prefix: "🔁 #", suffix: "" },
		// OMP segments default to OMP's Nerd Font glyphs (symbolPreset "nerd").
		hostname: { prefix: " ", suffix: "" },
		session: { prefix: "\u{f0051} ", suffix: "" },
		subagents: { prefix: " ", suffix: "" },
		commit: { prefix: " ", suffix: "" },
		token_in: { prefix: " ", suffix: "" },
		token_out: { prefix: " ", suffix: "" },
		token_total: { prefix: " ", suffix: "" },
		token_rate: { prefix: " ", suffix: "" },
		cache_read: { prefix: " ", suffix: "" },
		cache_write: { prefix: " ", suffix: "" },
		cache_hit: { prefix: " ", suffix: "" },
		context_total: { prefix: " ", suffix: "" },
		time_spent: { prefix: " ", suffix: "" },
	},
