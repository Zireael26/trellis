...
| `jq-fail-closed.bats` | P1.5 across jq-dependent executable hooks derived from both hook trees — fails closed without env, degrades cleanly with `TRELLIS_NO_JQ_DEGRADE=1` |
