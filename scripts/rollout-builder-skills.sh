...
echo "     cross-machine merges. The current fragment already lists them."
echo "  2. Older projects carry pre-9-skill gitignore fragments that do not"
echo "     list the new execute/brainstorming symlinks. Run onboard-project.sh on"
