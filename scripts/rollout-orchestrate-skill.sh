#!/usr/bin/env bash
# Rollout: reconcile the attachment-managed `orchestrate` skill surface for
...
#
# Usage:
#   rollout-orchestrate-skill.sh                 # interactive, all local registry rows
#   rollout-orchestrate-skill.sh --dry-run       # show reconciliation plan only
#   rollout-orchestrate-skill.sh --yes           # non-interactive
#   rollout-orchestrate-skill.sh <fleet/project> # one logical project
#   rollout-orchestrate-skill.sh <project>       # one unambiguous project ID
